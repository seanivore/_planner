...
**Status**: 4 points ready for agent handoff 
  ...
  2. Explore the tools on this list
     ...
     - Potential ideas for what these tools could each be used for. 
     - I used to make a lot of money trading BTC derivatives and am interested in automated bot trading 
     - The email for Claude and the browser 
       - If actually as open as they say 
  ...
  3. I want to know all about Forrest Bathing 
     ...
     - I have handwritten notes I'll be uploading 
